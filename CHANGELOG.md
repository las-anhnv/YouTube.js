...
## [17.0.1](https://github.com/las-anhnv/YouTube.js/compare/v17.0.0...v17.0.1) (2026-04-28)


### ⚠ BREAKING CHANGES

* **Search:** Update search filters to match YouTube changes ([#1136](https://github.com/las-anhnv/YouTube.js/issues/1136))
* **Innertube:** Remove getTrending as YouTube removed the trending feed ([#1114](https://github.com/las-anhnv/YouTube.js/issues/1114))
* **Player:** Use AST-based JS extraction with side-effect safe code emission ([#1052](https://github.com/las-anhnv/YouTube.js/issues/1052))
...
* **StreamingInfoOptions:** Add `is_sabr` option ([#974](https://github.com/las-anhnv/YouTube.js/issues/974))
* Remove `web.bundle.min`
* **parser:** Remove old comment node
* **Log:** Convert Log class to module ([#814](https://github.com/las-anhnv/YouTube.js/issues/814))
* **parser:** Remove getters that have been deprecated for a long time ([#815](https://github.com/las-anhnv/YouTube.js/issues/815))
* **parser:** Implement endpoint/command parsers ([#812](https://github.com/las-anhnv/YouTube.js/issues/812))
...
* **OAuth2:** Rewrite auth module ([#661](https://github.com/las-anhnv/YouTube.js/issues/661))

### Features

* **account:** Add missing property `channel_handle` ([#789](https://github.com/las-anhnv/YouTube.js/issues/789)) ([677e1f0](https://github.com/las-anhnv/YouTube.js/commit/677e1f08075a4a59274f89f3eb65967d7d0ab01b))
* **Actions:** Allow auth check to be skipped ([67f13ff](https://github.com/las-anhnv/YouTube.js/commit/67f13fffacec2c655a03d66c6d8016620d9abcf9))
* Add `getCourses` ([#798](https://github.com/las-anhnv/YouTube.js/issues/798)) ([cfb48fa](https://github.com/las-anhnv/YouTube.js/commit/cfb48fab89792d87a7377eaf15a56d289d26769b))
* Add `MWEB` client ([4bf125b](https://github.com/las-anhnv/YouTube.js/commit/4bf125b6a53460f631410e1ab949a16cc0c7d095))
* Add `TV_SIMPLY` client ([8cf6581](https://github.com/las-anhnv/YouTube.js/commit/8cf658151fc4e4266fadfb7e53dd5db3db693355))
* Add `TVHTML5` InnerTube client ([b45609a](https://github.com/las-anhnv/YouTube.js/commit/b45609aa0fcd801c379ffdafd04c6c3c2ed3deba))
* add `VideoMetadataCarouselView` ([#839](https://github.com/las-anhnv/YouTube.js/issues/839)) ([9a9bb76](https://github.com/las-anhnv/YouTube.js/commit/9a9bb76a928594c5c5f3e828c86081bf79c2562d))
* Add `WEB_CREATOR` client ([#757](https://github.com/las-anhnv/YouTube.js/issues/757)) ([dd7f5cf](https://github.com/las-anhnv/YouTube.js/commit/dd7f5cf778b8acca95cc6d9c6e379e3e87e0ee8a))
* Add `WEB_EMBEDDED` client ([#756](https://github.com/las-anhnv/YouTube.js/issues/756)) ([eaf218f](https://github.com/las-anhnv/YouTube.js/commit/eaf218f5da758fc37d71f7d00ba9e42533194f8a))
* Add AccessibilityContext and CommandContext classes + improve type definitions and parsing logic across multiple nodes ([923e9c2](https://github.com/las-anhnv/YouTube.js/commit/923e9c28e34b00841413824d82d10bf644186edc))
* add support of cloudflare workers ([#596](https://github.com/las-anhnv/YouTube.js/issues/596)) ([2029aec](https://github.com/las-anhnv/YouTube.js/commit/2029aec90de3c0fdb022094d7b704a2feed4133b))
* **Channel:** Add `getCourses` method ([#883](https://github.com/las-anhnv/YouTube.js/issues/883)) ([b3a4862](https://github.com/las-anhnv/YouTube.js/commit/b3a48621518f09d1ce309071499d9626cc1a8488))
* **ChipBarView:** Parse `renderer_context` ([3915883](https://github.com/las-anhnv/YouTube.js/commit/39158838f1b4a8c414ddbabd94b5a48198b16b2f))
* **ChipView:** Improve types ([32623de](https://github.com/las-anhnv/YouTube.js/commit/32623de4850fb2ae27c2b8317c2d00fea1a78227))
* **CommentsView:** parse `voice_reply_transcript` ([#981](https://github.com/las-anhnv/YouTube.js/issues/981)) ([d6f13e2](https://github.com/las-anhnv/YouTube.js/commit/d6f13e20ac6806e7a97dc8c3bd6bb947be6fd76c))
* **CommentView:** Implement comment interaction methods ([1c08bfe](https://github.com/las-anhnv/YouTube.js/commit/1c08bfe113804c69fbc4e49b42442d9a63d73be6))
* **CommentView:** Parse `prepareAccountCommand` ([d0d48bf](https://github.com/las-anhnv/YouTube.js/commit/d0d48bf525cc2a95dd3397a3142bea113ea9782e))
* **CommentView:** Parse some extra tooltips ([32125c7](https://github.com/las-anhnv/YouTube.js/commit/32125c704565f425806a0721edd96e01028e3fdd))
* **CompactLink:** Parse `subtitle`, `iconType`, and `iconType` ([6d57353](https://github.com/las-anhnv/YouTube.js/commit/6d57353a8021430a5253e2fb2c974ca98d731791))
* **ContentMetadataView:** Parse `enableTruncation` ([#863](https://github.com/las-anhnv/YouTube.js/issues/863)) ([0a3104b](https://github.com/las-anhnv/YouTube.js/commit/0a3104bafc03ccd29420a835b420f628b380991d))
* **DashManifest:** Add DRM infos to MPD ([7ae4ccf](https://github.com/las-anhnv/YouTube.js/commit/7ae4ccf70ad78bac7d6421d94df529f8f79a13f3))
* **EngagementPanelTitleHeader:** Add `contextual_info` and `menu` ([af3a916](https://github.com/las-anhnv/YouTube.js/commit/af3a91645d84798e744519ec8f24e565cc1ecdb1))
* extend music getInfo to allow MusicResponsiveListItem and Nav Endpoints ([#751](https://github.com/las-anhnv/YouTube.js/issues/751)) ([5db449c](https://github.com/las-anhnv/YouTube.js/commit/5db449cc6d86b2df1e92302ec5c74e6d44d822fb))
* **Format:** Add `is_drc` ([#656](https://github.com/las-anhnv/YouTube.js/issues/656)) ([6bb2086](https://github.com/las-anhnv/YouTube.js/commit/6bb2086875d089f47c5f86ce94db9e32cb051319))
* **Format:** Add `is_secondary` for detecting secondary audio tracks ([#697](https://github.com/las-anhnv/YouTube.js/issues/697)) ([a352dde](https://github.com/las-anhnv/YouTube.js/commit/a352ddeb9db001e99f49025048ad0942d84f1b3e))
* **Format:** Add `projection_type` and `stereo_layout` ([#643](https://github.com/las-anhnv/YouTube.js/issues/643)) ([064436c](https://github.com/las-anhnv/YouTube.js/commit/064436cef30e892d8f569d4f7b146557fd72b09f))
* **Format:** Add `spatial_audio_type` ([#647](https://github.com/las-anhnv/YouTube.js/issues/647)) ([0ba8c54](https://github.com/las-anhnv/YouTube.js/commit/0ba8c54257b068d7e4518c982396acb42f1dd41d))
* **Format:** Add support for Voice Boost & Super Resolution formats ([#1092](https://github.com/las-anhnv/YouTube.js/issues/1092)) ([769721c](https://github.com/las-anhnv/YouTube.js/commit/769721c193f2073522a9d35708a07dc8b493f1c7))
* **FormatUtils:** choose more specific format by itag or codec ([#884](https://github.com/las-anhnv/YouTube.js/issues/884)) ([1c1577e](https://github.com/las-anhnv/YouTube.js/commit/1c1577e85fd46cbfa15bcee6531d9aafdda787e5))
* **getSearchSuggestions:** Add optional `pq` param for better suggestions ([c61db19](https://github.com/las-anhnv/YouTube.js/commit/c61db19f2e3bd44bc5bf2ebdf8de041f169d8fab))
* **history:** Add ability to remove videos from watch history ([#706](https://github.com/las-anhnv/YouTube.js/issues/706)) ([22dd71d](https://github.com/las-anhnv/YouTube.js/commit/22dd71d7dad5029f2f7ed0deafbae3386ebe298d))
* **history:** Load additional watch history pages ([#1055](https://github.com/las-anhnv/YouTube.js/issues/1055)) ([6c12719](https://github.com/las-anhnv/YouTube.js/commit/6c127199bad65f3a0086c02c48463eaac22e5077))
* **Innertube:** Add `getAttestationChallenge` ([#869](https://github.com/las-anhnv/YouTube.js/issues/869)) ([33c27dd](https://github.com/las-anhnv/YouTube.js/commit/33c27ddcb5ea96241b2a0bf4ec14ec5937264998))
* **Innertube:** Add `GetVideoInfoOptions` to support content bound PoTokens ([#994](https://github.com/las-anhnv/YouTube.js/issues/994)) ([b6386e4](https://github.com/las-anhnv/YouTube.js/commit/b6386e40274432591a9063059e8b688da0d26c38))
* **Innertube:** Add ability to get individual community posts and community post comments ([#861](https://github.com/las-anhnv/YouTube.js/issues/861)) ([360b29e](https://github.com/las-anhnv/YouTube.js/commit/360b29ee60af2cf803106ca5315c365ddacbe51b))
* **ListView:** Add some missing fields ([cf54129](https://github.com/las-anhnv/YouTube.js/commit/cf5412986b102be7e8e11c87a0d877249caedce5))
* **LiveChatPaidMessage:** Parse `headerOverlayImage` and `lowerBumper` ([#851](https://github.com/las-anhnv/YouTube.js/issues/851)) ([ef37aa0](https://github.com/las-anhnv/YouTube.js/commit/ef37aa0a5abb573f192f86d1accb88d90d707752))
* **Log:** Convert Log class to module ([#814](https://github.com/las-anhnv/YouTube.js/issues/814)) ([fc55716](https://github.com/las-anhnv/YouTube.js/commit/fc5571629eca037af7de03f4b903da6add1f300b))
* **MediaInfo:** Add `updateWatchTime` ([#874](https://github.com/las-anhnv/YouTube.js/issues/874)) ([065e9a4](https://github.com/las-anhnv/YouTube.js/commit/065e9a4e7c3fee90f68d06992cf979338f8e3aba))
* **MultiPageMenuNotificationSection:** Add `notification_section_title` ([f869011](https://github.com/las-anhnv/YouTube.js/commit/f8690118c3e4edbc22a6b9f59477a8e40e39d9a3))
* **Music:** Add continuation support for "Up next" tab in `TrackInfo` ([#770](https://github.com/las-anhnv/YouTube.js/issues/770)) ([2913d5f](https://github.com/las-anhnv/YouTube.js/commit/2913d5f43dd28b9146cf05607cbe28d727463d51))
* **MusicImmersiveHeader:** Parse buttons and menu ([cbb2535](https://github.com/las-anhnv/YouTube.js/commit/cbb2535b2492777b0045be5fcf9bece03fe4f84e))
* **NavigationEndpoint:** Add name property ([bdebb9f](https://github.com/las-anhnv/YouTube.js/commit/bdebb9f741291d2f0640274454c90b5ccda8ea5d))
* **PageHeaderView:** Parse `heroImage` ([a602a31](https://github.com/las-anhnv/YouTube.js/commit/a602a317aaaffa575d2b03754f0625a6e5858162))
* **parser-classes:** Add `CompositeVideoPrimaryInfo` parser class ([#984](https://github.com/las-anhnv/YouTube.js/issues/984)) ([6386976](https://github.com/las-anhnv/YouTube.js/commit/638697696f54482c5270b0d11d1a7a33b5cd902a))
* **parser:** `Add AnimatedThumbnailOverlayView` ([#903](https://github.com/las-anhnv/YouTube.js/issues/903)) ([0cb92d9](https://github.com/las-anhnv/YouTube.js/commit/0cb92d9620c13bf6b719b384f917ad2a658e15b1))
* **parser:** Add `ActiveAccountHeader` ([5f233ae](https://github.com/las-anhnv/YouTube.js/commit/5f233ae34e278e7f7a0c48e4ba762d9bac9e312f))
* **parser:** Add `AddToPlaylist` node ([2940f7b](https://github.com/las-anhnv/YouTube.js/commit/2940f7b908ee720492994a41efdabb9fae08708c))
* **parser:** Add `animated_image` to `PageHeaderView` ([#819](https://github.com/las-anhnv/YouTube.js/issues/819)) ([8e50ebd](https://github.com/las-anhnv/YouTube.js/commit/8e50ebd92583ae76b080fed4c7599684370dc09d))
* **Parser:** Add `AvatarStackView` ([c631022](https://github.com/las-anhnv/YouTube.js/commit/c6310228fee1ed01f93a0e4e0482d09a967ef1be))
* **parser:** Add `ButtonCardView` ([#834](https://github.com/las-anhnv/YouTube.js/issues/834)) ([eeaae62](https://github.com/las-anhnv/YouTube.js/commit/eeaae6209f238b838b9b7fdd9bbef89f4f858fa3))
* **parser:** Add `ChangeEngagementPanelVisibilityAction` ([c2b2d7a](https://github.com/las-anhnv/YouTube.js/commit/c2b2d7ad52d2cdd1d721ae4569fb6f8cb0540476))
* **parser:** Add `ChangeEngagementPanelVisibilityEndpoint` ([2824900](https://github.com/las-anhnv/YouTube.js/commit/28249008521b4cb600756f8ff83e10ec3037ba69))
* **parser:** Add `ClientSideToggleMenuItem` ([#835](https://github.com/las-anhnv/YouTube.js/issues/835)) ([0b2b0da](https://github.com/las-anhnv/YouTube.js/commit/0b2b0da9577f8d6ad19393700071ea9f26d4da10))
* **Parser:** Add `DismissableDialog` and `DismissableDialogContentSection` nodes ([#997](https://github.com/las-anhnv/YouTube.js/issues/997)) ([e94ef37](https://github.com/las-anhnv/YouTube.js/commit/e94ef3748e6a38f192d79e5f12165933c6e6dc94))
* **parser:** Add `EomSettingsDisclaimer` node ([#703](https://github.com/las-anhnv/YouTube.js/issues/703)) ([a9bf225](https://github.com/las-anhnv/YouTube.js/commit/a9bf225a62108e47a50316235a83a814c682d745))
* **parser:** Add `Form.ts` parser class ([#1056](https://github.com/las-anhnv/YouTube.js/issues/1056)) ([3d6ed1d](https://github.com/las-anhnv/YouTube.js/commit/3d6ed1def90f5e673969cac650c2250fe98d8768))
* **Parser:** Add `HowThisWasMadeSectionView` node ([5da8a66](https://github.com/las-anhnv/YouTube.js/commit/5da8a66551c85fa45a01713383e6f621db053b46))
* **Parser:** Add `HypePointsFactoid` node ([0091f51](https://github.com/las-anhnv/YouTube.js/commit/0091f51dd2691dd1031896dd52c989426534dae8))
* **parser:** Add `LiveChatBannerChatSummary` node, update `TextRun` node ([#809](https://github.com/las-anhnv/YouTube.js/issues/809)) ([7fb00fa](https://github.com/las-anhnv/YouTube.js/commit/7fb00fa378574d1567d436f8a824fbb618db2373))
* **parser:** Add `LiveChatBannerRedirect` node ([#799](https://github.com/las-anhnv/YouTube.js/issues/799)) ([ad302b8](https://github.com/las-anhnv/YouTube.js/commit/ad302b8b17c0bfc1d81728130d4ba25a88ed241f))
* **parser:** add `LiveChatModeChangeMessage` node ([#811](https://github.com/las-anhnv/YouTube.js/issues/811)) ([7156a58](https://github.com/las-anhnv/YouTube.js/commit/7156a585c036a5000d0a50f3f4860a462762fdfe))
* **parser:** Add `LiveChatSponsorshipsGiftPurchaseAnnouncement` and `LiveChatSponsorshipsHeader` nodes ([#793](https://github.com/las-anhnv/YouTube.js/issues/793)) ([4e9c2a5](https://github.com/las-anhnv/YouTube.js/commit/4e9c2a585bf84751dd4e3964f70fba284c8b8e38))
* **parser:** Add `LiveChatSponsorshipsGiftRedemptionAnnouncement` node ([#795](https://github.com/las-anhnv/YouTube.js/issues/795)) ([20f7971](https://github.com/las-anhnv/YouTube.js/commit/20f797129973c6b91fa228e50d375b0c9d0226d2))
* **parser:** Add `MenuFlexibleItem` ([bc9a0ed](https://github.com/las-anhnv/YouTube.js/commit/bc9a0ed6c1dd7aac280e0461823827d71ce0991f))
* **Parser:** Add `MusicResponsiveHeader` node ([ea82bea](https://github.com/las-anhnv/YouTube.js/commit/ea82beaa10f6c877d6dd3102e10f6ae382560e0f))
* **parser:** Add `NotificationAction` node ([d36ddb8](https://github.com/las-anhnv/YouTube.js/commit/d36ddb804a03b7d22cd20c2b846f86dd49689c0c))
* **Parser:** Add `OpenOnePickAddVideoModalCommand` node ([#901](https://github.com/las-anhnv/YouTube.js/issues/901)) ([ff1aa67](https://github.com/las-anhnv/YouTube.js/commit/ff1aa67b8bebd8e038ea77a124d0be0ed420bc55))
* **parser:** Add `PlayerOverlayVideoDetails` node ([dc2ed04](https://github.com/las-anhnv/YouTube.js/commit/dc2ed046b8424134c675f30e7452fbd6bda0d228))
* **parser:** Add `PlaylistThumbnailOverlay` ([c8173c8](https://github.com/las-anhnv/YouTube.js/commit/c8173c88e0e17ec4bb4e93af1867c55d07611cc0))
* **parser:** Add `ReplaceLiveChatAction` ([#847](https://github.com/las-anhnv/YouTube.js/issues/847)) ([342fdd1](https://github.com/las-anhnv/YouTube.js/commit/342fdd1db30bc61de5f19fc4ed35db8931706903))
* **parser:** Add `RunAttestationCommand` ([4729016](https://github.com/las-anhnv/YouTube.js/commit/4729016fb98e7045ee4043857be7eef780c01e35))
* **Parser:** Add `SectionHeaderView` and `GridShelfView` ([#988](https://github.com/las-anhnv/YouTube.js/issues/988)) ([bc386db](https://github.com/las-anhnv/YouTube.js/commit/bc386db6bad4040580b85ce64a39a30d9a04cb38))
* **parser:** Add `ShortsLockupView` and `BadgeView` nodes ([#746](https://github.com/las-anhnv/YouTube.js/issues/746)) ([e1e76ee](https://github.com/las-anhnv/YouTube.js/commit/e1e76ee61629f84f4b7de9579ae9f6d6bf97bab8))
* **parser:** Add `ShowEngagementPanelEndpoint` ([ec85b0f](https://github.com/las-anhnv/YouTube.js/commit/ec85b0f9421156c674c5c4d4a3a2e39eca7dbfbf))
* **parser:** Add `ShowSheetCommand` and `SheetView` ([37a4808](https://github.com/las-anhnv/YouTube.js/commit/37a480869372831429de439924baabde5d8ac43b))
* **parser:** Add `SignalAction` node ([feeb21b](https://github.com/las-anhnv/YouTube.js/commit/feeb21b3ebb83772fcceb1f6b0a90c17db613451))
* **Parser:** Add `ThumbnailOverlayTitleView` and `PageIndicatorView` classes ([#1120](https://github.com/las-anhnv/YouTube.js/issues/1120)) ([2a33fbc](https://github.com/las-anhnv/YouTube.js/commit/2a33fbc85fd7a25b25696e1a1ab75ed4afde3e10))
* **Parser:** Add `ToggleFormField` node ([#902](https://github.com/las-anhnv/YouTube.js/issues/902)) ([42bcf19](https://github.com/las-anhnv/YouTube.js/commit/42bcf197bc8b3117e40d8f61300a97332e4963ba))
* **parser:** Add `UnifiedSharePanel` ([4a1397f](https://github.com/las-anhnv/YouTube.js/commit/4a1397f1bcc2ad9964626b11c90831b90989b6af))
* **parser:** Add `UpdateSubscribeButtonAction` ([fdb7540](https://github.com/las-anhnv/YouTube.js/commit/fdb754043b809223ae8938fbbdd5780f585b697e))
* **parser:** Add `VideoAttributesSectionView` node ([#732](https://github.com/las-anhnv/YouTube.js/issues/732)) ([4b60b97](https://github.com/las-anhnv/YouTube.js/commit/4b60b97132b0ee42b41838f3336c582a7f7f7aec))
* **parser:** Add `VideoSummaryContentView` and `VideoSummaryParagraphView` ([#1153](https://github.com/las-anhnv/YouTube.js/issues/1153)) ([da1fac2](https://github.com/las-anhnv/YouTube.js/commit/da1fac2d294061229ff550bf08b071206777b97d))
* **parser:** Add `VideoViewCount` node ([ad448f8](https://github.com/las-anhnv/YouTube.js/commit/ad448f8106116e44e65eb5f5351c38fc4a31d809))
* **parser:** add classdata to unhandled parse errors ([#691](https://github.com/las-anhnv/YouTube.js/issues/691)) ([090539b](https://github.com/las-anhnv/YouTube.js/commit/090539b28f9bc3387d01e37325ba5741b33b1765))
* **parser:** Add FormPopup.ts parser class ([#1057](https://github.com/las-anhnv/YouTube.js/issues/1057)) ([f738a17](https://github.com/las-anhnv/YouTube.js/commit/f738a173fc88d04adb6276894d577b437cf0e532))
* **parser:** Add ListView, ListItemView and SubscribeButtonView ([#1025](https://github.com/las-anhnv/YouTube.js/issues/1025)) ([68a6af9](https://github.com/las-anhnv/YouTube.js/commit/68a6af9b2c2e4e5a31b2d6f5c5add6c238e5113e))
* **parser:** Add mobile guide nodes ([ad2ae51](https://github.com/las-anhnv/YouTube.js/commit/ad2ae51b97d84dcb9d2547b4cfef7402f2410404))
* **parser:** Add optional image property to LockupMetadataView ([#806](https://github.com/las-anhnv/YouTube.js/issues/806)) ([0914299](https://github.com/las-anhnv/YouTube.js/commit/091429921530d65daf8f5b281c7c54117ee9a474))
* **Parser:** add support for parsing subtitle for `RichShelf` ([#805](https://github.com/las-anhnv/YouTube.js/issues/805)) ([038efff](https://github.com/las-anhnv/YouTube.js/commit/038efff17f3b12d80619c8990ca880e919d2bfe5))
* **Parser:** Add support for parsing subtitle for `Shelf` ([#792](https://github.com/las-anhnv/YouTube.js/issues/792)) ([34ae38c](https://github.com/las-anhnv/YouTube.js/commit/34ae38cbf4aa0a42a6024fa99eb0fe553639c8ce))
* **Parser:** Implement utility class to parse `rendererContext` ([3a11b99](https://github.com/las-anhnv/YouTube.js/commit/3a11b99429ff9d8cc9aebc7bbee0b7645e30f7ff))
* **parser:** Parse `OpenPopupAction` in `onResponseReceivedEndpoints` arrays ([45b7342](https://github.com/las-anhnv/YouTube.js/commit/45b734288e070ef5e347cec5bae445d0cf883eba))
* **parser:** Parse `targetId` ([458c490](https://github.com/las-anhnv/YouTube.js/commit/458c4900d78f9b16761faae421bcd8cb302f19b8))
* **parser:** Parse badges in ContentMetadataView ([#1017](https://github.com/las-anhnv/YouTube.js/issues/1017)) ([aa7cf56](https://github.com/las-anhnv/YouTube.js/commit/aa7cf561a7cdec017383b9daa6c9401f08995d4c))
* **Parser:** Parse YpcTrailer in VideoInfo ([#842](https://github.com/las-anhnv/YouTube.js/issues/842)) ([c0043d0](https://github.com/las-anhnv/YouTube.js/commit/c0043d0194f582c2ed85341291e2eace25dd78d8))
* **parser:** Support CommentView nodes ([#614](https://github.com/las-anhnv/YouTube.js/issues/614)) ([900f557](https://github.com/las-anhnv/YouTube.js/commit/900f5572021d348e7012909f2080e52eac06adae))
* **parser:** Support LockupView and it's child nodes ([#609](https://github.com/las-anhnv/YouTube.js/issues/609)) ([7ca2a0c](https://github.com/las-anhnv/YouTube.js/commit/7ca2a0c3e43ebd4b9443e69b7432f302b09e9c7a))
* **parser:** Update `Button` ([#857](https://github.com/las-anhnv/YouTube.js/issues/857)) ([5f899fc](https://github.com/las-anhnv/YouTube.js/commit/5f899fcdb30deefc189e8325e4358812c5b05800))
* **parser:** Update `LiveChatBanner` ([#840](https://github.com/las-anhnv/YouTube.js/issues/840)) ([69d42b2](https://github.com/las-anhnv/YouTube.js/commit/69d42b291c927abb9d84f97ed03518c4ddd4506e))
* **parser:** Update `LiveChatMembershipItem` ([#836](https://github.com/las-anhnv/YouTube.js/issues/836)) ([0c319aa](https://github.com/las-anhnv/YouTube.js/commit/0c319aacdeba106d84b7f44505a7a296a154f97a))
* **parser:** Update `LiveChatPaidMessage` ([#846](https://github.com/las-anhnv/YouTube.js/issues/846)) ([73362c6](https://github.com/las-anhnv/YouTube.js/commit/73362c68fbc8b966ff46cc8b145e1e8d9fbe32ee))
* **parser:** Update `LiveChatPaidSticker` ([#849](https://github.com/las-anhnv/YouTube.js/issues/849)) ([3c28c0d](https://github.com/las-anhnv/YouTube.js/commit/3c28c0d2c2b583a31fe0e49cce4cdfbfe380874d))
* **parser:** Update `LiveChatTextMessage` ([#864](https://github.com/las-anhnv/YouTube.js/issues/864)) ([9025122](https://github.com/las-anhnv/YouTube.js/commit/902512248417ae86e25082d429b13d8c57a5c5b1))
* **parser:** Update `LiveChatTickerPaidMessageItem` ([#845](https://github.com/las-anhnv/YouTube.js/issues/845)) ([29e8d30](https://github.com/las-anhnv/YouTube.js/commit/29e8d3015a3d17383a8be4e6f46b389d10f111f3))
* **parser:** Update `LiveChatTickerPaidStickerItem` ([#848](https://github.com/las-anhnv/YouTube.js/issues/848)) ([5f83a74](https://github.com/las-anhnv/YouTube.js/commit/5f83a7416d5dc3167e6af2767e9b90f4bf89f3dc))
* **parser:** Update `LiveChatViewerEngagementMessage` ([#856](https://github.com/las-anhnv/YouTube.js/issues/856)) ([b4a947a](https://github.com/las-anhnv/YouTube.js/commit/b4a947a9eb9dd1ae6e9d1da1a00083ac1afca03e))
* **Platform:** Add support for `react-native` platform ([#593](https://github.com/las-anhnv/YouTube.js/issues/593)) ([2980a60](https://github.com/las-anhnv/YouTube.js/commit/2980a608b67f18416d7f73f1bdbcf4b897307b26))
* **Player:** Add support for Proof of Identity tokens ([#708](https://github.com/las-anhnv/YouTube.js/issues/708)) ([c9f0ddd](https://github.com/las-anhnv/YouTube.js/commit/c9f0ddd573de297c0b384e422e6c1737454926e2))
* **PlaylistManager:** Add ability to remove videos by set ID ([#715](https://github.com/las-anhnv/YouTube.js/issues/715)) ([d85fbc5](https://github.com/las-anhnv/YouTube.js/commit/d85fbc56cf0fd7367b182ae36e65c1701bc5e62d))
* **Playlists:** Implement `addToLibrary` and `removeFromLibrary` ([#844](https://github.com/las-anhnv/YouTube.js/issues/844)) ([48460e4](https://github.com/las-anhnv/YouTube.js/commit/48460e4184bac0f6626550b80696f950f7626beb))
* **proto:** Add `comment_id` to commentSectionParams ([#693](https://github.com/las-anhnv/YouTube.js/issues/693)) ([a5f6209](https://github.com/las-anhnv/YouTube.js/commit/a5f62093a18705fc822abd86beaa81788b6535ce))
* **protos:** Add playlistTitle field to NextParams ([#1040](https://github.com/las-anhnv/YouTube.js/issues/1040)) ([ee9c184](https://github.com/las-anhnv/YouTube.js/commit/ee9c184eeb02d1074e06c81897a6fd97078da18b))
* **ProtoUtils:** Add support for creating NextParams ([#762](https://github.com/las-anhnv/YouTube.js/issues/762)) ([910c979](https://github.com/las-anhnv/YouTube.js/commit/910c9791e7aed9e28cd42f3bcf28b8b8d89edb21))
* **RichGrid:** Parse `targetId` ([e571ee2](https://github.com/las-anhnv/YouTube.js/commit/e571ee2426c6003c1bc690cbf98b0ab72ebfaa10))
* **RichRenderers:** Parse more UI elements ([d8f731b](https://github.com/las-anhnv/YouTube.js/commit/d8f731b2fa4b755324b0ef4ad68be45f735b29a9))
* **RichShelf:** Add `icon_type` property ([dce51cd](https://github.com/las-anhnv/YouTube.js/commit/dce51cdc4abad21812ee9e7ba02885dffde35d3a))
* **Search:** Update search filters to match YouTube changes ([#1136](https://github.com/las-anhnv/YouTube.js/issues/1136)) ([e830396](https://github.com/las-anhnv/YouTube.js/commit/e83039637e4d7ac857f437a630a8013d6528a544))
* **Session:** Add `configInfo` to InnerTube context ([5a8fd3a](https://github.com/las-anhnv/YouTube.js/commit/5a8fd3ad37bce1decad28ec3727453ddd430a561))
* **Session:** Add `deviceExperimentId` and `rolloutToken` to session data ([c704836](https://github.com/las-anhnv/YouTube.js/commit/c7048368cc38a6a322c8006a4cfd208235d27caf))
* **Session:** Add `enable_session_cache` option ([#664](https://github.com/las-anhnv/YouTube.js/issues/664)) ([7953296](https://github.com/las-anhnv/YouTube.js/commit/795329658033652625d2d61b275ccf703573a437))
* **Session:** Add `fail_fast` option ([#1066](https://github.com/las-anhnv/YouTube.js/issues/1066)) ([d4e4683](https://github.com/las-anhnv/YouTube.js/commit/d4e4683d9435814e1b0807b4343df81b0a12116a))
* **Session:** Add `retrieve_innertube_config` option ([#949](https://github.com/las-anhnv/YouTube.js/issues/949)) ([4808d2e](https://github.com/las-anhnv/YouTube.js/commit/4808d2e13a90710cdea2c72332deb7809d5fdbdd))
* **Session:** Add option to override Player ID ([#951](https://github.com/las-anhnv/YouTube.js/issues/951)) ([5e665e8](https://github.com/las-anhnv/YouTube.js/commit/5e665e8f0ba6e68d689b42be852ec20597c6b6a6))
* **Session:** Add the `ANDROID_VR` client ([#1149](https://github.com/las-anhnv/YouTube.js/issues/1149)) ([f9bd5d0](https://github.com/las-anhnv/YouTube.js/commit/f9bd5d0e8db39dcb6c68ccc52446fbaa793e04fa))
* **Session:** Allow using a fixed user agent for InnerTube requests ([#876](https://github.com/las-anhnv/YouTube.js/issues/876)) ([4d36655](https://github.com/las-anhnv/YouTube.js/commit/4d36655b2dad74aeb74e869ca8259e9d13dfb512))
* **StreamingInfo:** Label Voice Boost audio streams ([#1105](https://github.com/las-anhnv/YouTube.js/issues/1105)) ([458f881](https://github.com/las-anhnv/YouTube.js/commit/458f88104344fda2e2ca41c9504d946d367a0cb7))
* **StreamingInfoOptions:** Add `is_sabr` option ([#974](https://github.com/las-anhnv/YouTube.js/issues/974)) ([561e60b](https://github.com/las-anhnv/YouTube.js/commit/561e60b934df29520eb0bd83a98e42fa4d7d35bb))
* **SubscribeButton:** Add `unsubscribe_text` ([75b8964](https://github.com/las-anhnv/YouTube.js/commit/75b89641805abada1498edebac5b72a40860b215))
* **SubscribeButton:** Parse more endpoints ([8bf9eb7](https://github.com/las-anhnv/YouTube.js/commit/8bf9eb7044ad9a5de0892207690195f5646df288))
* Support auto-dubbed audio tracks ([#786](https://github.com/las-anhnv/YouTube.js/issues/786)) ([a4ef224](https://github.com/las-anhnv/YouTube.js/commit/a4ef2249ffbe14f5d5fa702b269dd0f61e14ada8))
* **Text:** Parse accessibility data ([a95f52a](https://github.com/las-anhnv/YouTube.js/commit/a95f52a4777ea158f3d3e85f4213aee364a2d38d))
* **Text:** Support formatting and emojis in `fromAttributed` ([#615](https://github.com/las-anhnv/YouTube.js/issues/615)) ([e6f1f07](https://github.com/las-anhnv/YouTube.js/commit/e6f1f078a828f8ea5db1fe7aec9f677bc53694e3))
* **toDash:** Add option to include WebVTT or TTML captions ([#673](https://github.com/las-anhnv/YouTube.js/issues/673)) ([bd9f6ac](https://github.com/las-anhnv/YouTube.js/commit/bd9f6ac64ca9ba96e856aabe5fcc175fd9c294dc))
* **toDash:** Add support for stable volume/DRC ([#662](https://github.com/las-anhnv/YouTube.js/issues/662)) ([031ffb6](https://github.com/las-anhnv/YouTube.js/commit/031ffb696e3b7e160779e8b55a49b0cfa9f95620))
* **toDash:** Add the "dub" role to translated captions ([#677](https://github.com/las-anhnv/YouTube.js/issues/677)) ([858cdd1](https://github.com/las-anhnv/YouTube.js/commit/858cdd197cb2bb1e1d7a7285966cb56043ad8961))
* **ToggleButtonView:** Add `is_toggled` ([88af6d8](https://github.com/las-anhnv/YouTube.js/commit/88af6d89a56907d6f2263c01fc158400788fb5b4))
* **Utils:** Add `UMP` parser ([261f2ac](https://github.com/las-anhnv/YouTube.js/commit/261f2ac12b6a9a5bd5f7a43557018de333f7bec3))
* **VideoInfo:** implement `MacroMarkersListEntity` parser for heatmap ([#973](https://github.com/las-anhnv/YouTube.js/issues/973)) ([876e94a](https://github.com/las-anhnv/YouTube.js/commit/876e94ad03398f546ef7942deb9ba5eb8baa6c6d))
* **VideoViewCount:** Add `extra_short_view_count` field ([d10fe68](https://github.com/las-anhnv/YouTube.js/commit/d10fe6834a0d063d94b65289d54a52ed3398eff4))


### Bug Fixes

* add missing `TV_SIMPLY` parts on some files ([#975](https://github.com/las-anhnv/YouTube.js/issues/975)) ([689fb0b](https://github.com/las-anhnv/YouTube.js/commit/689fb0b90edab6f0e4326a35144541d68f72fe01))
* **Artist:** `getAllSongs` not finding target shelf ([#999](https://github.com/las-anhnv/YouTube.js/issues/999)) ([64f9955](https://github.com/las-anhnv/YouTube.js/commit/64f995585fd0ee908bdc5404929996e9a5e5c3c9))
* **ButtonCardView:** Correct typo ([#855](https://github.com/las-anhnv/YouTube.js/issues/855)) ([6536801](https://github.com/las-anhnv/YouTube.js/commit/6536801ec2e4f9b93d1e272b7b04e2777b74abad))
* **ButtonView:** Rename `type` property to `button_type` ([15f3b5f](https://github.com/las-anhnv/YouTube.js/commit/15f3b5fdba17f11cddada168de268546875e48f9))
* **Cache:** handle the value read from the db correctly according to its type ([#620](https://github.com/las-anhnv/YouTube.js/issues/620)) ([3170659](https://github.com/las-anhnv/YouTube.js/commit/317065988007c860bf6173b0ac3c3d685ed81d20))
* **Cache:** Use `TextEncoder` to encode compressed data ([384b80e](https://github.com/las-anhnv/YouTube.js/commit/384b80ee41d7547a00d8dc17c50c8542629264b5))
* **ChannelSubMenu:** Handle potential `undefined` values ([543b94c](https://github.com/las-anhnv/YouTube.js/commit/543b94c3e4edca29fbd84fcb82fb894d078c28d7))
* **Channel:** Use new URL for community tab ([#986](https://github.com/las-anhnv/YouTube.js/issues/986)) ([dfaf150](https://github.com/las-anhnv/YouTube.js/commit/dfaf1501c93e29bd27a5553df0ee5b46d490ac12))
* **CommentThread:** Replies not being parsed correctly ([66e34f9](https://github.com/las-anhnv/YouTube.js/commit/66e34f9388429a2088d5c5835d19eebdc881c957))
* **Constants:** Add `TVHTML5_SIMPLY` to `CLIENT_NAME_IDS` ([b15f623](https://github.com/las-anhnv/YouTube.js/commit/b15f623dab3acb44eaef33175df2d22d35be2979))
* **Constants:** Update the iOS client version ([#924](https://github.com/las-anhnv/YouTube.js/issues/924)) ([219d88b](https://github.com/las-anhnv/YouTube.js/commit/219d88b2005431c6697f04e1fa2c5e8528a9ce57))
* **ContentMetadataView:** `metadataRows` can be `undefined` ([19b33ea](https://github.com/las-anhnv/YouTube.js/commit/19b33ea36e20ef36e483cf24369305f5eca9e5f0))
* **dependencies:** Update `jintr` to version 3.2.1 ([02dfcae](https://github.com/las-anhnv/YouTube.js/commit/02dfcae612dd528ce4f1f3f6c62ceefd02a5c790))
* **DescriptionPreviewView:** Parsing errors when certain fields are missing ([c2dd803](https://github.com/las-anhnv/YouTube.js/commit/c2dd803eeaeec3292d92bc0efaaa2404fb87355c))
* **DialogView:** Type mismatch ([#897](https://github.com/las-anhnv/YouTube.js/issues/897)) ([b731db8](https://github.com/las-anhnv/YouTube.js/commit/b731db86c51ba292c848272f28b5a9aa2e2a6956))
* **examples:** Use BgUtils to generate pot [skip ci] ([d89909a](https://github.com/las-anhnv/YouTube.js/commit/d89909a19a1486bee7e3275014725b4e3dc2cbe2))
* **ExpandableVideoDescriptionBody:** Parse attributed description ([360580e](https://github.com/las-anhnv/YouTube.js/commit/360580ea6ea6fbdd7fbc0aa038d96b17de17e4f4))
* fix deno usage of protobuf and jintr ([#776](https://github.com/las-anhnv/YouTube.js/issues/776)) ([02513b7](https://github.com/las-anhnv/YouTube.js/commit/02513b76ed66041044e80f8749df7f29379c424e))
* **FlexibleActionsView:** Update `ActionRow` actions type ([#1129](https://github.com/las-anhnv/YouTube.js/issues/1129)) ([5c7b1ba](https://github.com/las-anhnv/YouTube.js/commit/5c7b1ba25d17ea0aacf043f402140b217c419f19))
* **FlexibleActionsView:** Update actions array type to include `ToggleButtonView` ([040a091](https://github.com/las-anhnv/YouTube.js/commit/040a09163903b914f546d5083dbfdeab7175b24c))
* **FormatOptions:** `client` missing some values ([fcd00b0](https://github.com/las-anhnv/YouTube.js/commit/fcd00b0fb0f88a16c27da1ed89e9a2c4887e5c52))
* **Format:** Parse xtags from protobuf to support SABR-only responses ([#909](https://github.com/las-anhnv/YouTube.js/issues/909)) ([00c199a](https://github.com/las-anhnv/YouTube.js/commit/00c199ac69bc6d7be19aeae04a245f30b64272c2))
* **FormatUtils#download:** Add missing await for format.decipher() call in download function ([ca05eab](https://github.com/las-anhnv/YouTube.js/commit/ca05eab0c38042fa28f526947870edd6659fd208))
* **FormatUtils:** itag matching ([#886](https://github.com/las-anhnv/YouTube.js/issues/886)) ([774b3a7](https://github.com/las-anhnv/YouTube.js/commit/774b3a75244db85ceb7b00f658dc2dfeb2eb4e7e))
* **FormatUtils:** Throw an error if download requests fails ([a19511d](https://github.com/las-anhnv/YouTube.js/commit/a19511de24bb82007aab072844efe64bbb8698da))
* **gen-parser-map:** update reference to the script in auto-generated files ([#1036](https://github.com/las-anhnv/YouTube.js/issues/1036)) ([d448fd2](https://github.com/las-anhnv/YouTube.js/commit/d448fd28064bac396b20856e39e499bb84955876))
* **getBasicInfo:** Add racyCheckOk and contentCheckOk to payload ([#961](https://github.com/las-anhnv/YouTube.js/issues/961)) ([0f1fd72](https://github.com/las-anhnv/YouTube.js/commit/0f1fd7223c2e5c8e28637e84a1c00c6d88fad50f))
* **getSearchSuggestions:** Allow empty queries ([523700b](https://github.com/las-anhnv/YouTube.js/commit/523700b728e8b2f126b1b6266dc153ad683dcbcb))
* Handle CommandExecutorCommand in NavigationEndpoint.call ([#968](https://github.com/las-anhnv/YouTube.js/issues/968)) ([698121a](https://github.com/las-anhnv/YouTube.js/commit/698121ab8f62fbed6e78892277caf93a9890b930))
* **history:** Add support for `LockupView` content ([#1075](https://github.com/las-anhnv/YouTube.js/issues/1075)) ([7e10ac9](https://github.com/las-anhnv/YouTube.js/commit/7e10ac987347ec380ac52c524d102c99a98d737d))
* **HTTPClient:** Adjust more context fields for the iOS client ([#705](https://github.com/las-anhnv/YouTube.js/issues/705)) ([3153375](https://github.com/las-anhnv/YouTube.js/commit/3153375bcaa6c03afba9da8474e6a9d37471ed29))
* **HTTPClient:** Use the correct constant for the iOS client OS name ([#938](https://github.com/las-anhnv/YouTube.js/issues/938)) ([95d9211](https://github.com/las-anhnv/YouTube.js/commit/95d9211eae51c2d47468cacbed8cd9bdaa2fcd33))
* Include jinter in the cjs build ([305a398](https://github.com/las-anhnv/YouTube.js/commit/305a398158a6cac82e6ef288fed4bf1661c89d52))
* **InfoPanelContainer:** Use new attributed text prop ([5cdb9e1](https://github.com/las-anhnv/YouTube.js/commit/5cdb9e1e2fa4ad5abdb3659bb35d0b3edc60123c))
* **InfoPanelContent:** Update InfoPanelContent node to also support `paragraphs` ([4cbaa79](https://github.com/las-anhnv/YouTube.js/commit/4cbaa7983f35a82b9907197769672ac3b300bfbe))
* **Innertube#getPost:** Update protobuf schema ([#987](https://github.com/las-anhnv/YouTube.js/issues/987)) ([e9d6483](https://github.com/las-anhnv/YouTube.js/commit/e9d6483e5a3c53efab6e29083e32f9a2e238bedc))
* **innertube:** Allowing `getStreamingData` to use client ([#895](https://github.com/las-anhnv/YouTube.js/issues/895)) ([5aecd0a](https://github.com/las-anhnv/YouTube.js/commit/5aecd0ace96c371f0b15cdc6e45ef09beb5696af))
* **Innertube:** getChannel() if subscribed ([#1128](https://github.com/las-anhnv/YouTube.js/issues/1128)) ([3df4c61](https://github.com/las-anhnv/YouTube.js/commit/3df4c61bd7853cc7e9d5c3be13c1ef7a8360807b))
* **Innertube:** Handle redirects in getChannel() ([#1002](https://github.com/las-anhnv/YouTube.js/issues/1002)) ([cb87cc1](https://github.com/las-anhnv/YouTube.js/commit/cb87cc1cae43b75ea31f984a9c6939097d58dd6f))
* **Innertube:** Properly encoded params in getPost() ([#882](https://github.com/las-anhnv/YouTube.js/issues/882)) ([7d5c972](https://github.com/las-anhnv/YouTube.js/commit/7d5c972c98d7c69b0b687b241c652f3098907a9f))
* **Innertube:** Properly encoded params in getPostComments() ([#955](https://github.com/las-anhnv/YouTube.js/issues/955)) ([92b8623](https://github.com/las-anhnv/YouTube.js/commit/92b8623374a126d60604a54fa4be67b460ddc5e3))
* **Innertube:** Remove getTrending as YouTube removed the trending feed ([#1114](https://github.com/las-anhnv/YouTube.js/issues/1114)) ([7c144ee](https://github.com/las-anhnv/YouTube.js/commit/7c144ee013c2d168d93f203c34f88c8c3bfb4068))
* **InteractionManager:** Use `WEB` for all actions ([d9ac99d](https://github.com/las-anhnv/YouTube.js/commit/d9ac99d3324c2987aebb6b8e40317780478b7c19))
* **ItemSection:** FeedFilterChipBar parse error ([#741](https://github.com/las-anhnv/YouTube.js/issues/741)) ([bf6cc00](https://github.com/las-anhnv/YouTube.js/commit/bf6cc006997675010db61fcd776244b234be5611))
* **LiveChat#sendMessage:** Switch to `WEB` client ([bb3f114](https://github.com/las-anhnv/YouTube.js/commit/bb3f114aa34dd50602da794dcb3aa3f28a5a2ed9))
* **LiveChatTextMessage:** Make some fields optional ([#877](https://github.com/las-anhnv/YouTube.js/issues/877)) ([a035b71](https://github.com/las-anhnv/YouTube.js/commit/a035b7169614ac92081b8cb377711d7da559e65b))
* **LockupMetadataView:** Parse `menuButton` ([3ffdee9](https://github.com/las-anhnv/YouTube.js/commit/3ffdee9554b06db137d93e43b33fac124becf31f))
* **LockupView:** Add overlay nodes used by `VIDEO` views ([424c653](https://github.com/las-anhnv/YouTube.js/commit/424c65356c24d19a921e24aadcbbb3cd03ab103a))
* **LockupView:** Fix `content_image` parsing ([083aec1](https://github.com/las-anhnv/YouTube.js/commit/083aec1c805cce6b04a75e4f017b5cdf0bb6108e))
* Make "deno" conditional export have higher precedence than "node" ([#983](https://github.com/las-anhnv/YouTube.js/issues/983)) ([2996ebb](https://github.com/las-anhnv/YouTube.js/commit/2996ebb334d98cfde72243c233366285db945d02))
* **MediaInfo:** Remove unused parameters from `toDash` method ([3fcf987](https://github.com/las-anhnv/YouTube.js/commit/3fcf987aecbb43ed16aa4d29a2d66c3c4ef15175))
* **music#getPlaylist:** Handle `ContinuationItem` nodes ([a3fafe2](https://github.com/las-anhnv/YouTube.js/commit/a3fafe2f7979313906dbaf1a7f9779f411266d6b)), closes [#904](https://github.com/las-anhnv/YouTube.js/issues/904)
* **MusicResponsiveHeader:** Add `Text` import ([583fd9f](https://github.com/las-anhnv/YouTube.js/commit/583fd9f8d70735d071b34bd1d68faa62eeac593a))
* **package:** Use `jsr:@luanrt/jintr` on Deno ([d9ec23c](https://github.com/las-anhnv/YouTube.js/commit/d9ec23c73ca4f370df45926206a2ff070bb6552f))
* **Parser:** Add `UpdateEngagementPanelContentCommand` ([3f960ef](https://github.com/las-anhnv/YouTube.js/commit/3f960effa24c3b14fa3c6aadf4c7badf0ac965c9))
* **Parser:** Fix ChannelSubMenu parsing ([#1144](https://github.com/las-anhnv/YouTube.js/issues/1144)) ([5da9dd3](https://github.com/las-anhnv/YouTube.js/commit/5da9dd37a727be792ff4da2c5031cc000d692502))
* **parser:** Fix ShortsLockupView assuming that the primary text always exists ([#775](https://github.com/las-anhnv/YouTube.js/issues/775)) ([43cef9e](https://github.com/las-anhnv/YouTube.js/commit/43cef9e67e9defbfc498b6381ae93f967622f83b))
* **parser:** ignore MiniGameCardView node ([#692](https://github.com/las-anhnv/YouTube.js/issues/692)) ([6d0bc89](https://github.com/las-anhnv/YouTube.js/commit/6d0bc89be18f27a8ce74517f5cab5020d6790328))
* **parser:** LockupMetadataView.image can also be an AvatarStackView ([#1026](https://github.com/las-anhnv/YouTube.js/issues/1026)) ([bac8965](https://github.com/las-anhnv/YouTube.js/commit/bac896501b9525c28b319301151a0dde93d08ec0))
* **parser:** Resolve some old parser issues ([#1154](https://github.com/las-anhnv/YouTube.js/issues/1154)) ([8130f80](https://github.com/las-anhnv/YouTube.js/commit/8130f808d9bbccf185c69534b624f15715c739d5)), closes [#653](https://github.com/las-anhnv/YouTube.js/issues/653) [#781](https://github.com/las-anhnv/YouTube.js/issues/781) [#978](https://github.com/las-anhnv/YouTube.js/issues/978) [#1053](https://github.com/las-anhnv/YouTube.js/issues/1053) [#695](https://github.com/las-anhnv/YouTube.js/issues/695) [#1098](https://github.com/las-anhnv/YouTube.js/issues/1098)
* **parser:** The AvatarView.image_processor property is optional ([#807](https://github.com/las-anhnv/YouTube.js/issues/807)) ([4b178e4](https://github.com/las-anhnv/YouTube.js/commit/4b178e4bfbc4cb003ed098afcd0370f98dbf834b))
* **parser:** The icon_name property does not always exist in ThumbnailBadgeView ([#745](https://github.com/las-anhnv/YouTube.js/issues/745)) ([094a96f](https://github.com/las-anhnv/YouTube.js/commit/094a96fb5d8170d1f727ef6da84b258596b1a09a))
* **parser:** ThumbnailView background color ([#686](https://github.com/las-anhnv/YouTube.js/issues/686)) ([0f8f92a](https://github.com/las-anhnv/YouTube.js/commit/0f8f92a28a5b6143e890626b22ce570730a0cf09))
* **parser:** Update list of possible content_type in LockupView ([#808](https://github.com/las-anhnv/YouTube.js/issues/808)) ([680da9f](https://github.com/las-anhnv/YouTube.js/commit/680da9f501db02a9bed2fa8357df021e63024e5f))
* **Player:** Add more ways to find the nsig algo ([acfb0c5](https://github.com/las-anhnv/YouTube.js/commit/acfb0c58bec25782aa92963cd590a56967229d62))
* **Player:** Add support for new variants ([#1152](https://github.com/las-anhnv/YouTube.js/issues/1152)) ([d8558af](https://github.com/las-anhnv/YouTube.js/commit/d8558afd58dd6c000669b0dc7c62c666e24bc356))
* **Player:** Bump cache version ([283172f](https://github.com/las-anhnv/YouTube.js/commit/283172f22032d60b407cb0159a391a147b569432))
* **Player:** Bump cache version ([#702](https://github.com/las-anhnv/YouTube.js/issues/702)) ([6765f4e](https://github.com/las-anhnv/YouTube.js/commit/6765f4e0d791c657fc7411e9cdd2c0f9284e9982))
* **PlayerEndpoint:** Don't set `undefined` fields ([0e91a08](https://github.com/las-anhnv/YouTube.js/commit/0e91a08ae2194a07defc4b1e12ff3edbe13b72df))
* **PlayerEndpoint:** Workaround for "The following content is not available on this app" (Android) ([#624](https://github.com/las-anhnv/YouTube.js/issues/624)) ([d589365](https://github.com/las-anhnv/YouTube.js/commit/d589365ea27f540ff36e33a65362c932cd28c274))
* **Player:** Fix extracting the n-token decipher algorithm ([#682](https://github.com/las-anhnv/YouTube.js/issues/682)) ([142a7d0](https://github.com/las-anhnv/YouTube.js/commit/142a7d042885188605bdc0655d3733502d1e20fa))
* **Player:** Fix extracting the n-token decipher algorithm again ([#701](https://github.com/las-anhnv/YouTube.js/issues/701)) ([3048f70](https://github.com/las-anhnv/YouTube.js/commit/3048f70f60756884bd7b591d770f7b6343cfa259))
* **Player:** Fix global variable extraction in the deciphering code ([#1029](https://github.com/las-anhnv/YouTube.js/issues/1029)) ([3ea2815](https://github.com/las-anhnv/YouTube.js/commit/3ea2815abac03ae7371e45ae2f2758caf9db2266))
* **Player:** Fix signature algorithm extraction ([#832](https://github.com/las-anhnv/YouTube.js/issues/832)) ([ce4996c](https://github.com/las-anhnv/YouTube.js/commit/ce4996cea7b0607cb7f9aca7ae9c9e439d964a5a))
* **Player:** Fix signature algorithm extraction again ([#837](https://github.com/las-anhnv/YouTube.js/issues/837)) ([13e7961](https://github.com/las-anhnv/YouTube.js/commit/13e796123b87136f2d5d3b3c9b3ed079a014bf46))
* **Player:** Parse global variable used by nsig/sig ([#935](https://github.com/las-anhnv/YouTube.js/issues/935)) ([edfd65f](https://github.com/las-anhnv/YouTube.js/commit/edfd65f5e08a9155b8c31d8127a4e309313b39de))
* **Player:** Store the full library version in cache entries ([#1032](https://github.com/las-anhnv/YouTube.js/issues/1032)) ([a2c3774](https://github.com/las-anhnv/YouTube.js/commit/a2c3774e9a0212d7aab7af2baee1f48ad3319a08))
* **Player:** Use global var to find signature algorithm ([#953](https://github.com/las-anhnv/YouTube.js/issues/953)) ([7f1eeb6](https://github.com/las-anhnv/YouTube.js/commit/7f1eeb6b5bbae72d455609e8fd972ad936a69e27))
* **PlaylistAddToOption:** Use correct type for `contains_selected_videos` ([53d1c75](https://github.com/las-anhnv/YouTube.js/commit/53d1c759b65ce9b6cb9f236c02828077d4f506cc))
* **Playlist:** is_editable ([#894](https://github.com/las-anhnv/YouTube.js/issues/894)) ([2b42199](https://github.com/las-anhnv/YouTube.js/commit/2b4219959cbbb27cd80788e66b608fdeed3a1f1e))
* **proto:** Update `Context` message ([62ac2f6](https://github.com/las-anhnv/YouTube.js/commit/62ac2f6f32d35fec3c31b5f5d556bd4569fa49f9)), closes [#681](https://github.com/las-anhnv/YouTube.js/issues/681)
* **ReelPlayerOverlay:** Update `subscribe_button_renderer` type to include SubscribeButton ([daa5a29](https://github.com/las-anhnv/YouTube.js/commit/daa5a2982b24f107681050f2b534986b4d374c5d))
* **Search:** Fix it occasionally returning only a small number of results ([#720](https://github.com/las-anhnv/YouTube.js/issues/720)) ([2c0bb23](https://github.com/las-anhnv/YouTube.js/commit/2c0bb237e1d0eb160dc3f879f5cab2022d9b5b04))
* **sendMessage:** Handle `RunAttestationCommand` in response actions ([#859](https://github.com/las-anhnv/YouTube.js/issues/859)) ([826a954](https://github.com/las-anhnv/YouTube.js/commit/826a9541a44121bafe4ce19f2cd4a68fcabb2384))
* **Session:** `PoToken` not being set correctly ([#729](https://github.com/las-anhnv/YouTube.js/issues/729)) ([bb6e647](https://github.com/las-anhnv/YouTube.js/commit/bb6e647b8c88753669acde43d0d648aaf11caba6))
* **Session:** Add the ID for ANDROID_VR, remove the mistaken ANDROID_TV key. ([#1151](https://github.com/las-anhnv/YouTube.js/issues/1151)) ([c712c54](https://github.com/las-anhnv/YouTube.js/commit/c712c546c3c4b5b3766ac77205ccef683eb51545))
* **Session:** Fix remote visitor data not gettting used ([#731](https://github.com/las-anhnv/YouTube.js/issues/731)) ([7afc3da](https://github.com/las-anhnv/YouTube.js/commit/7afc3da80ee3b5aa6edd2a899be82c1a21e03556))
* **Session:** Incorrect session client logic ([76504c0](https://github.com/las-anhnv/YouTube.js/commit/76504c0d0875228299dddf24bd550ed2a5e4244f))
* **Session:** Initialize client version based on provided client name ([#971](https://github.com/las-anhnv/YouTube.js/issues/971)) ([bb022e8](https://github.com/las-anhnv/YouTube.js/commit/bb022e8285e0bf2dfa709e7401b80f9de18833e1))
* **Session:** Round UTC offset minutes ([84f90aa](https://github.com/las-anhnv/YouTube.js/commit/84f90aaf2908ecacb9dfb6ce5497c4c4d14a72c3))
* **Session:** Set default values for `hl` and `gl` in context builder ([7a39326](https://github.com/las-anhnv/YouTube.js/commit/7a3932682112a0d76c04f65ae35445fc35403a00))
* **Session:** Visitor data not being used properly ([f1973c1](https://github.com/las-anhnv/YouTube.js/commit/f1973c11d9a492898b5e72b1f2b79291b674e229))
* **SignalAction:** Rename `action` to `signal` ([8ab760e](https://github.com/las-anhnv/YouTube.js/commit/8ab760ea2e268a4f108b2b4a8d46193f5450bf4c))
* **SubscribeButton:** Parse endpoints using `NavigationEndpoint` ([126a66f](https://github.com/las-anhnv/YouTube.js/commit/126a66f317da0c6b486202ad04483b9799bfaf4c))
* **Text#fromAttributed:** Fix `StyleRun` assuming that the `startIndex` and `length` always exist ([#862](https://github.com/las-anhnv/YouTube.js/issues/862)) ([732a30c](https://github.com/las-anhnv/YouTube.js/commit/732a30c09f50a9d78d5d1686ffef88a3bde2e53e))
* **Text#toHTML:** Return empty string if the text is `undefined` ([f3c777b](https://github.com/las-anhnv/YouTube.js/commit/f3c777b31638cc9c6ce7f4b7ba566ff0534b47dc))
* **TextRun:** Add `img` element only if an URL is available ([913dcc7](https://github.com/las-anhnv/YouTube.js/commit/913dcc74eadf1a5df7878688d2c6cf434642f1b5))
* **ThumbnailOverlayResumePlayback:** Update `percent_duration_watched` type ([#737](https://github.com/las-anhnv/YouTube.js/issues/737)) ([f9ccba4](https://github.com/las-anhnv/YouTube.js/commit/f9ccba4af5268d67d8610a1a5d623964f56d170d))
* **toDash:** Add missing transfer characteristics for h264 streams ([#631](https://github.com/las-anhnv/YouTube.js/issues/631)) ([0107049](https://github.com/las-anhnv/YouTube.js/commit/010704929fa4b737f68a5a1f10bf0b166cfbf905))
* **toDash:** Fix dash.js 4.x compatibility ([#765](https://github.com/las-anhnv/YouTube.js/issues/765)) ([5ff30e1](https://github.com/las-anhnv/YouTube.js/commit/5ff30e12ded29afff5a758cbe96ac3418e6d20aa))
* **toDash:** Fix default audio stream for dubbed movie trailers ([#858](https://github.com/las-anhnv/YouTube.js/issues/858)) ([0054690](https://github.com/las-anhnv/YouTube.js/commit/00546909c02841c7e404766b13f2c02e42e3f6fc))
* **toDash:** Fix image representations not being spec compliant ([#672](https://github.com/las-anhnv/YouTube.js/issues/672)) ([e5aab9a](https://github.com/las-anhnv/YouTube.js/commit/e5aab9a9b35f0752cd5ca50bfa25936dce4718c6))
* **types:** Parser.parseArray always returns an ObservedArray ([#1014](https://github.com/las-anhnv/YouTube.js/issues/1014)) ([8be677a](https://github.com/las-anhnv/YouTube.js/commit/8be677adec6631be557c95adc8f687e5d01b4fdf))
* **UnifiedSharePanel:** Check if `thirdPartyNetworkSection` exists ([d3f6af0](https://github.com/las-anhnv/YouTube.js/commit/d3f6af07754f75c578dc11e8ea4815ad91f0cac4))
* **VideoAttributeView:** Parse `secondarySubtitle` only if exists ([0a99342](https://github.com/las-anhnv/YouTube.js/commit/0a99342ccbd6f8b1c611ef6b157a599ff5ae2247))
* **VideoCard:** fix parsing author, view count and published date ([#791](https://github.com/las-anhnv/YouTube.js/issues/791)) ([a4394db](https://github.com/las-anhnv/YouTube.js/commit/a4394dbb82203eeabcb8684ca9105f83e3b0fb1b))
* **VideoInfo:** Fix like count being undefined ([#787](https://github.com/las-anhnv/YouTube.js/issues/787)) ([182bf42](https://github.com/las-anhnv/YouTube.js/commit/182bf42d3cdf5148c667e958cd4d4eaa091a6d68))
* **VideoSecondaryInfo:** Parse `show_more_text` and `show_less_text` correctly ([790f817](https://github.com/las-anhnv/YouTube.js/commit/790f8172fc2bbdbf17f16b04a2676fd9088d8878))
* **workflow:** Add `id-token` permission for release-please job ([561e69d](https://github.com/las-anhnv/YouTube.js/commit/561e69d8b7a1dada852aa24797d728f6b9943413))
* **YTMusic:** Add support for new header layouts ([14c3a06](https://github.com/las-anhnv/YouTube.js/commit/14c3a06d402989e98a9d32c79b2dc26f74fb0219))


### Performance Improvements

* **constants:** Move the client name IDs into their own CLIENT_NAME_IDS object ([#875](https://github.com/las-anhnv/YouTube.js/issues/875)) ([06887e9](https://github.com/las-anhnv/YouTube.js/commit/06887e99fb1c2546e74b5026cb1ae1ce0be2e3e9))
* **general:** Add session cache and LZW compression ([#663](https://github.com/las-anhnv/YouTube.js/issues/663)) ([cf29664](https://github.com/las-anhnv/YouTube.js/commit/cf29664d376ff792602400ef9a4ac301c676735c))
* Optimise DASH manifest generation ([#870](https://github.com/las-anhnv/YouTube.js/issues/870)) ([1a3d663](https://github.com/las-anhnv/YouTube.js/commit/1a3d663cc56a54b8517eb5f82e7892d37db3082e))
* Replace uses of ObservableArray#get with Array#find ([#1013](https://github.com/las-anhnv/YouTube.js/issues/1013)) ([95976de](https://github.com/las-anhnv/YouTube.js/commit/95976de115587d8f266bc44355440835f3b2b02f))


### Reverts

* "fix(toDash): Fix default audio stream for dubbed movie trailers ([#858](https://github.com/las-anhnv/YouTube.js/issues/858))" ([#896](https://github.com/las-anhnv/YouTube.js/issues/896)) ([4325717](https://github.com/las-anhnv/YouTube.js/commit/432571769ebc6634c2c9a4c1b5e53cfbbd2a5f0a))


### Miscellaneous Chores

* **parser:** Remove getters that have been deprecated for a long time ([#815](https://github.com/las-anhnv/YouTube.js/issues/815)) ([9cf0d3f](https://github.com/las-anhnv/YouTube.js/commit/9cf0d3f3b3099af3dd59bc4ca99fefe217a91020))
* **release:** release 17.0.1 ([3cae95c](https://github.com/las-anhnv/YouTube.js/commit/3cae95c5314c66029cf97f400f79a99eef03899d))


### Code Refactoring

* Deprecate `account#getAnalytics`, `account#getTimeWatched` and `account#getAnalytics` ([0081e11](https://github.com/las-anhnv/YouTube.js/commit/0081e11ebcff8c719902d93edf8760d3e8702e00))
* Drop support for CommonJS ([d134fd2](https://github.com/las-anhnv/YouTube.js/commit/d134fd2e9e1b27aebd1095562cd5c5da32cbf6d8))
* **Innertube#getPlaylists:** Return a `Feed` instance instead of items ([7660450](https://github.com/las-anhnv/YouTube.js/commit/766045049d7154866e6fe32f6d965025d736d77d))
* **OAuth2:** Rewrite auth module ([#661](https://github.com/las-anhnv/YouTube.js/issues/661)) ([b6ce5f9](https://github.com/las-anhnv/YouTube.js/commit/b6ce5f903fa2285cb381d73aedf02cc5e2712478))
* **parser:** Implement endpoint/command parsers ([#812](https://github.com/las-anhnv/YouTube.js/issues/812)) ([7397aa3](https://github.com/las-anhnv/YouTube.js/commit/7397aa3f6425cb2f3dcc625502fd1ce5a5db6db3))
* **parser:** Remove old comment node ([2f087d4](https://github.com/las-anhnv/YouTube.js/commit/2f087d47a0199870b313717f3d01598f8168be4b))
* **Player:** Use AST-based JS extraction with side-effect safe code emission ([#1052](https://github.com/las-anhnv/YouTube.js/issues/1052)) ([25d0876](https://github.com/las-anhnv/YouTube.js/commit/25d0876b913d15039be3655cb266ca706b2409d8))
* Remove `web.bundle.min` ([e54e499](https://github.com/las-anhnv/YouTube.js/commit/e54e499ff553dab51e6d9d1aebc090b50fec29ba))
